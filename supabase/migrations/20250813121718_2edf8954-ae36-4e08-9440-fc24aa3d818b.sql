...
-- Get the category ID for inserting questions
...
SELECT c.id, 'Η Αθήνα είναι η πρωτεύουσα της Ελλάδας.', 'true-false', 1, 10, 'true', '["Σωστό", "Λάθος"]', 'Η Αθήνα είναι πράγματι η πρωτεύουσα της Ελλάδας.'
FROM public.categories c WHERE c.name = 'Γενικές Γνώσεις';

INSERT INTO public.questions (category_id, question_text, question_type, difficulty_level, points_value, correct_answer, options, explanation)
SELECT c.id, 'Ποια είναι η μεγαλύτερη χώρα στον κόσμο;', 'multiple-choice', 2, 15, 'Ρωσία', '["ΗΠΑ", "Κίνα", "Ρωσία", "Καναδάς"]', 'Η Ρωσία είναι η μεγαλύτερη χώρα στον κόσμο με έκταση 17.1 εκατομμύρια τετραγωνικά χιλιόμετρα.'
FROM public.categories c WHERE c.name = 'Γενικές Γνώσεις';

INSERT INTO public.questions (category_id, question_text, question_type, difficulty_level, points_value, correct_answer, options, explanation)
SELECT c.id, 'Ο Ήλιος είναι ένας πλανήτης.', 'true-false', 1, 10, 'false', '["Σωστό", "Λάθος"]', 'Ο Ήλιος είναι αστέρι, όχι πλανήτης.'
FROM public.categories c WHERE c.name = 'Γενικές Γνώσεις';

INSERT INTO public.questions (category_id, question_text, question_type, difficulty_level, points_value, correct_answer, options, explanation)
SELECT c.id, 'Πόσα χρόνια έχει μια δεκαετία;', 'multiple-choice', 1, 10, '10', '["5", "10", "15", "20"]', 'Μια δεκαετία αποτελείται από 10 χρόνια.'
FROM public.categories c WHERE c.name = 'Γενικές Γνώσεις';